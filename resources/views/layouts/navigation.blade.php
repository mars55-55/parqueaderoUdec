<nav x-data="{ open: false }" class="bg-blue-900 border-b border-blue-800 shadow-lg">
            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}">
                        <img src="{{ asset('images/udec-logo.png') }}" alt="Logo UDEC" class="h-10">
                    </a>
                </div>

                <!-- Navigation Links -->
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('dashboard')" :active="request()->routeIs('dashboard')" class="text-white hover:text-blue-300 font-semibold">
                        {{ __('Inicio') }}
                    </x-nav-link>
                ...
                <div class="mt-3 space-y-1">
                    ...
                    <form method="POST" action="{{ route('logout') }}">
                        ...
                        <x-responsive-nav-link :href="route('logout')"
                            onclick="event.preventDefault();
                                        this.closest('form').submit();" class="text-white hover:text-blue-400">
                            {{ __('Cerrar Sesión') }}
                        </x-responsive-nav-link>
                    </form>
                </div>
